...
//		SharedPreferences prefs = KreyosActivity.getPrefs();
		...
		if ( PreferencesManager.getInstance() == null ) { return; }
		
		if( PreferencesManager.getInstance().retrieveDataForBoolean( "notification.email", false ) )
		{
...
//		&& prefs.getBoolean("notification.facebook", false) == true)
		...
		if ( PreferencesManager.getInstance().retrieveDataForBoolean( "notification.reminder", false ) ) {
		...
		if( PreferencesManager.getInstance().retrieveDataForBoolean( "notification.facebook", false ) )
		{
		...
		if( PreferencesManager.getInstance().retrieveDataForBoolean( "notification.twitter", false ) )
		{
