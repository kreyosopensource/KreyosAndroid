...
public class AutoResizeTextView extends TextView
  ...
  private void initFont(AttributeSet attrs) {
      ...
      for (int i = 0; i < N; ++i)
      {
          ...
          if ( attr == R.styleable.AutoResizeTextView_customFont ) {
              bUsesCustomFont = true;
              break;
          }
      }

      if (bUsesCustomFont) {
          switch ( R.styleable.AutoResizeTextView_customFont ) {
              case 0:
                  typeFace = Typeface.createFromAsset(getContext().getAssets(), "fonts/leaguegothic-regular-webfont.ttf");
                  break;

              case 1:
                  typeFace = Typeface.createFromAsset(getContext().getAssets(), "fonts/leaguegothic-italic-webfont.ttf");
                  break;

              case 2:
                  typeFace = Typeface.createFromAsset(getContext().getAssets(), "fonts/leaguegothic-condensed-regular-webfont.ttf");
                  break;

              case 3:
                  typeFace = Typeface.createFromAsset(getContext().getAssets(), "fonts/leaguegothic-condensed-italic-webfont.ttf");
                  break;
          }
