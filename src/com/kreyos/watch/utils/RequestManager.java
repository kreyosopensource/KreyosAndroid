...
import com.kreyos.watch.utils.LocalWeather.Params;
...
public class RequestManager 
{
	...
	public String post(
			...
			{ 
			    ...
			    httppost.setEntity( (HttpEntity) new ByteArrayEntity(p_json.toString().getBytes("UTF8")) );
				...
				StringEntity se = new StringEntity(p_json.toString());
